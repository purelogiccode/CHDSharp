...
public static unsafe partial class Methods
{
     ...
     *
     * Ensures that params->bucketSizeLog is
     * <
     * =
     * params-
     * >
     * hashLog (setting it to
    ...
    )
    {
        ...
        for (chunk = 0; chunk < nbChunks && sequences->size < sequences->capacity; ++chunk)
        {
            ...
            )
            {
                ...
                var correction = ZSTD_window_correctOverflow(
                    &ldmState->window,
                    0,
                    maxDist,
                    chunkStart
    ...
    )
    {
        ...
        var chosenCompressor = ZSTD_selectBlockCompressor(
            cParams->strategy,
            useRowMatchFinder,
            ...
            ZSTD_ldm_fillFastTables(ms, ip);
            {
                var newLitLength = (
                    (delegate* managed<
                        ...
                        nuint,
                        nuint>)chosenCompressor
                )(ms, seqStore, rep, ip, sequence.litLength);
        ...
        return (
            (delegate* managed<
                ...
                nuint,
                nuint>)chosenCompressor
        )(ms, seqStore, rep, ip, (nuint)(iend - ip));
    }
}