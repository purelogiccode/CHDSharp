...
public static unsafe partial class Methods
{
    ...
    private static nuint HIST_count_parallel_wksp(uint* count, uint* maxSymbolValuePtr, void* source, nuint sourceSize, HistCheckInputE check, uint* workSpace)
    {
        var ip = (byte*)source;
