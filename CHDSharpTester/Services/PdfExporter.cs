                    ...
                    container.Page(page =>
                    {
                        ...
                        page.Header()
                            .Column(header =>
                            {
                                header
                                    .Item()
                                    .Text("CHDSharp Tester — Results Report")
                                    .Bold()
                                    .FontSize(16)
                                ...
                                header
                                    ...
                                    .Row(row =>
                                    {
                                        ...
                                        row.ConstantItem(100)
                                            .Text($"Time: {session.TotalElapsedSeconds:N1}s")
                                            .FontSize(8)
                        ...
                        page.Content()
                            ...
                            .Table(table =>
                            {
                                ...
                                {
                                    var bgColor =
                                        file.AllPassed ? Colors.Green.Lighten5
                                        : file.Failed > 0 ? Colors.Red.Lighten5
                                    ...
                                    table
                                        ...
                                        .Background(bgColor)
                                        .Padding(3)
                                        .Text($"{file.ElapsedSeconds:N1}s")
                                        .FontSize(8);
                                    table
                                        .Cell()
                                        .Background(bgColor)
                                        .Padding(3)
                                        .Text(FormatSubTests(file))
                                        .FontSize(7);
                                    table
                                        .Cell()
                                        .Background(bgColor)
                                    ...
                                    table
                                        ...
                                        .Background(bgColor)
                                        .Padding(3)
                                        .Text($"{file.Passed}/{file.Failed}/{file.Skipped}")
                                        .FontSize(8);
                                }
                            });
                        ...
                        page.Footer()
                            .AlignCenter()
                            .Text("CHDSharp Tester — generated with QuestPDF")
                            .FontSize(7)
                            .FontColor(Colors.Grey.Medium);
                    });
                })
